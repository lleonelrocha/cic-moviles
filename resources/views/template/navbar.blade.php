<nav class="navbar navbar-default navbar-static-top" role="navigation" style="margin-bottom: 0">
    ...
    <div class="navbar-header">
        ...
        <a class="navbar-brand" href="index.html">CIC Mobiles </a>
    </div>
    <!-- /.navbar-header -->
    ...
    <div class="navbar-default sidebar" role="navigation">
        ...
        <div class="sidebar-nav navbar-collapse">
            <ul class="nav" id="side-menu">
                ...
                <li>
                    <a href="#"> Operativos <span class="fa arrow"></span></a>
                ...
                <li>
                    ...
                    <ul class="nav nav-second-level">
                        <li>
                            <a href="{{route('personas')}}">Lista Personal</a>
                        </li>
                        <li>
                            <a href="{{route('funciones')}}">Funcion Personal</a>
                        </li>

                        <li>
                            <a href="{{route('grupos')}}">Grupos de Trabajo</a>
                        </li>
                    </ul>
                    <!-- /.nav-second-level -->
                </li>
